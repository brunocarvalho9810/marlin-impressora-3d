...
#define STRING_CONFIG_H_AUTHOR "Bruno Carvalho" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bruno Carvalho"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1998.28, 200.35 }
